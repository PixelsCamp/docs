...
Pixels Camp's venue (Pavilhão Carlos Lopes) is in a very central location in the city, so there are plenty of hotels around. These are just a few examples:
...
In the Quiz Show teams answer tech/science related questions, in the Security CTF teams try to solve cybersecurity-related challenges, there's also a retro gaming competition where participants play classic games on stage, and these are just some examples.
